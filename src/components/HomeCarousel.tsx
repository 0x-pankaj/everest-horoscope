...
const HomeCarousel: React.FC = () => {
    ...
    <h1 className="text-5xl font-bold text-white mb-4">Welcome to Our Company</h1>
    <p className="text-2xl text-white mb-6">Discover the future of astrology with us</p>
    <div className="space-x-4">
        <button className="bg-white text-black font-bold py-2 px-4 rounded hover:bg-gray-200 transition-colors">
            Get Started
        </button>
        <button className="bg-transparent border-2 border-white text-white font-bold py-2 px-4 rounded hover:bg-white hover:text-black transition-colors">
            Learn More
        </button>
    </div>
</div>
