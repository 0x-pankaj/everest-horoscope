...
const ChatRoom: React.FC<ChatRoomProps> = ({ senderId, receiverId }) => {
  const { messages,addMessage ,sendMessage, fetchMessages, loading, error } = useTeamChatStore();
  ...
  useEffect(() => {
    if(!isFetched.current){
        ...
        client.subscribe(`databases.${conf.appwriteHoroscopeDatabaseId}.collections.${conf.appwriteMessageWithTeamCollectionId}.documents`, (response) => {
