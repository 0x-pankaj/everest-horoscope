...
const VastoServiceDisplay = ({
  ...
  return (
    <div className="max-h-[80vh] flex flex-col">
      ...
      <button
        onClick={onClose}
        className="mt-6 w-full bg-gradient-to-r from-purple-600 to-yellow-500 text-white py-2 px-4 rounded-md hover:from-purple-700 hover:to-yellow-600 sticky bottom-0"
      >
        Close
      </button>
    </div>
