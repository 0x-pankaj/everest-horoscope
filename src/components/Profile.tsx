...
const Profile: React.FC = () => {
  ...
  const handleDeleteAllSessions = async () => {
    if (window.confirm('Are you sure you want to delete all sessions? You will be logged out.')) {
    ...
    <div className="bg-white p-4 rounded shadow">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" value={user.$id} readOnly className="w-full p-2 border rounded bg-gray-100" />
        </div>
        <div>
